...
&nbsp;&nbsp;&nbsp;&nbsp;Հետևյալ նկարներում պատկերված է «Armenian Mnemonic» ստեղնաշարը՝ տարբեր մոդիֆիկատոր-ստեղների սեղման վիճակում, որոնցում բաց մոխրագույնով նշված են բաղադրյալ (համր) ստեղները։
